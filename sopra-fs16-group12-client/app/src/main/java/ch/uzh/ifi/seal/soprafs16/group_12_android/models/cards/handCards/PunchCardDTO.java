...
public class PunchCardDTO extends ActionCardDTO implements Serializable {
    ...
    public Card fetchCard() {
        return Globals.getInstance().characterMap.get(super.getPlayedByUserId()).generatePunchCard().setPlayedHidden(super.isPlayedHidden());
    }
}
